...
Pri naslednjem zemljevidu sem prvemu dodal točke, kjer velikost predstavlja koliko imajo povprečno golov na tekmo. Točke so se dodale na vse točke na meji in je nastalo kot obroba.
